...
if __name__=='__main__':                            
    ...
    #changing title
    window.title("SHAIKH FAIZAN")
    
    #changing size
    window.geometry("320x300")
    
    #adding Label
    tk.Label(window,text="Moonlight Cafe",font=("arial black",20)).place(x=70,y=80)
    
    #adding label
    tk.Button(window,text="START",command=moonlight_rest.order_process,width=25).place(x=90,y=150)
    
    # so if you want write this, window wont be visible
    window.mainloop()
